 ...
 */
package org.avphs.sbcio.fakefirm; // (class SimHookBase)      // 2018 December 18
...
public class SimHookBase { // override to drive simulator
  ...
  */
  ...
  public String toString() {return "(SimHookBase)";} //~toString
  public SimHookBase() {System.out.println("new SimHookBase");}} //~SimHookBase // (SB)
