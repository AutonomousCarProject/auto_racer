...
// (same API as fly0cam, same as 2017 Feb 27 but subclassable)

import org.avphs.camera.CameraBase;
...
public class FlyCamera extends CameraBase { // (in Java/fly2cam)
    ...
    // comment this line out if no DLLs
...
>>>>>>> Lots of camera stuff, hopefully works
        NextFrame(img);
        bayerImage = img;
    }
