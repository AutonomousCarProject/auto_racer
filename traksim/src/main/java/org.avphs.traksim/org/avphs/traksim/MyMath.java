 ...
 */
package org.avphs.traksim; // (class org.avphs.traksim.MyMath.MyMath)                  // 2018 May 25
...
public class MyMath {
     ...
     */
    public static int SgnExt(int whom) {return (whom&0x7FFF)-(whom&0x8000);}
     ...
     */
    public static int iAbs(int whom) {return Math.abs(whom);}
     ...
     */
    public static int iMax(int lft, int rit) {return Math.max(lft,rit);}
     ...
     *
     * org.avphs.traksim.TrakSim uses a (TV) raster coordinate system where (0,0) is the northwest
    ...
    public static double aTan0(double y, double x) { // in degrees, +/-0..180
        try {return Math.atan2(y,x)*180/Math.PI;}
        catch (Exception ex) {return 0.0;}} //~aTan0
     ...
     *
     * @return       The sine is in org.avphs.traksim.MyMath.MyMath.Sine and the cosine is in org.avphs.traksim.MyMath.MyMath.Cose
     */
    public static void Angle2cart(double degs) { // in degrees c-wise frm north
        ...
        Cose = (double)Math.cos(radn);} //~Angle2cart

    public MyMath() { // outer class const'r..FakeMath() {
        System.out.println("org.avphs.traksim.MyMath.MyMath");}
    ...
    } //~org.avphs.traksim.MyMath.MyMath (trakSimFiles) (MM)
} //~org.avphs.traksim.MyMath.MyMath (apw3) (MM)
