 ...
 */
package org.avphs.traksim; // (class org.avphs.traksim.HandyOps.HandyOps)                    // 2019 May 24
...
public class HandyOps { // first some useful debug logging ops..
    ...
    public static String Dec2Log(String before, int whom, String after) {
        return before + whom + after;} //~Dec2Log
    ...
    public static String Int2Log(String before, int whom, String after) {
        ...
        return Hex2Log(before,whom,8,after);} //~Int2Log
    ...
    public static String Flt2Log(String before, double whom, String after) {
        ...
        return before + info + after;} //~Flt2Log

    /**
     * Formats the time since org.avphs.traksim.TrakSim started as mm:ss:mss and returns it
    ...
    public static char CharAt(int here, String aStr) {
        ...
        catch (Exception ex) {return '\0';}} //~CharAt

    /**
     * Returns the time since org.avphs.traksim.TrakSim started, as integer seconds.
     *
    ...
    public static int NthOffset(int whom, String aWord, String aStr) {
        ...
        try {
            if (lxx>0) if (whom >= 0) while (true) {
                ...
                whom--;
                if (whom<0) break;
                thar = whar+lxx;}} //~while //~try
        catch (Exception ex) {}
        return whar;} //~NthOffset
    ...
    public static String NthItemOf(boolean lino, int whom, String aStr) {
        ...
        try {if (whom >= 0) for (here=0; here <= lxx-1; here++) {
            xCh = CharAt(here,aStr);
            if (xCh <= '\0') break;
            if (xCh <= ' ') {
    ...
    public static double SafeParseFlt(String aStr) {
        ...
        try {if (fpart !=0) {
            ...
            while (mode>0) {
                base = base*10.0;
                mode--;} //~while
            valu = valu+MyMath.Fix2flt(fpart,0)/base;}} //~if //~try
        catch (Exception ex) {}
        fraction = "";
        return valu;} //~SafeParseFlt
    ...
    public static String RepNthLine(String aLine, int whom, String aStr) {
        ...
        try {
            ...
            aStr = aWord + aLine + aStr;} //~try
        catch (Exception ex) {}
        return aStr;} //~RepNthLine
    ...
    public static int SafeCompare(String aStr, String xStr) {
        int whom = 0;
        try {
            if (aStr == "") {if (xStr != "") whom--;}
            else if (xStr == "") whom++;
            else whom = aStr.compareTo(xStr);} //~try
    ...
    public static String ArrayDumpLine(int[] theAry, int nw, int pos) {
        ...
        catch (Exception ex) {aLine = aLine + " [" + nx + "?]";}
        return aLine;} //~ArrayDumpLine
    ...
    public static String TimeStamp(boolean noDate) {
        ...
        Date now = new Date();
        return sdf.format(now);} //~TimeStamp
    ...
    public static String ReadWholeTextFile(String filename) {
        ...
        return content;} //~ReadWholeTextFile
    ...
    public static void WriteWholeTextFile(String filename, String content) {
        ...
        try {
            ...
            try {if (doit !=null) doit.close();} //~try
            catch (Exception ex) {}}} //~finally //~WriteWholeTextFile
    ...
    public static int Int4bytes(boolean LiLEfi, byte by0, byte by1,
        ...
        return (( (( ((( (int)by0)&255)<<8) | ((int)by1)&255)<<8) // unflipped..
                | ((int)by2)&255)<<8) | ((int)by3)&255;} //~Int4bytes
    ...
    public static int ReadTiff32Image(String filename, int[] pixels) {
        ...
        try { while (true) {
            ...
            if (SafeCompare(filename,TifFileNm) !=0) {
                ...
                samp = TifDataOfx>>24;} //~if  // this is +bytes/pixel (3 or 4)
            ...
            if (!markt) { // gotta read the index..
                ...
                if (tall>4096) break;
                why++; // why = 15
                if (tall*wide*samp != nby) break;} //~if // (gotta read the index)
            why = 16; // aStr = " = ";
            if (samp<3) break;
            if (samp>4) break;
            why++; // why = 17
            ...
            for (thar=0; thar <= lxx; thar++) {
                ...
                here = here+samp;
                pixels[thar] = info;} //~for
            why = 0;
            break;} //~while
            if (theFile != null) theFile.close(); // if (why != 16)
        } catch (Exception ex) {aStr = " = "; why = -why;}
        filename = " '" + filename + "'";
    ...
    public static String Fixt8th(String before, int whom, String after) {
        ...
        return before + ".?" + after;} //~Fixt8th

    public HandyOps() { // (unused) class const'r..FakeHandy() {
        System.out.println("new org.avphs.traksim.HandyOps.HandyOps");}

    /**
     * Handy Operations that should be simple (but maybe aren't so in Java)..
     */
    public static class HandyOps { // first some useful debug logging ops..
        ...
        final static int[] Tif32hed = {0x4D4D002A, 0x1E, 0x48, 1, 0x48, 1, 0, 0xD,
                ...
                0x01170004, 1, 0x00, 0x011A0005, 1, 0x08, 0x011B0005, 1, 0x10,    // @35=008C
                0x01280003, 1, 0x20000, 0, 0x80008, 0x80008};                     // @44=00B0
        private static final String CaptureImageBase = DriverConstants.D_CaptureImageBase;
        private static int CapDims = DriverConstants.Display_Height * 0x10000 + DriverConstants.Display_Width,
    ...
    } //~org.avphs.traksim.HandyOps.HandyOps (trakSimFiles) (HO)
} //~org.avphs.traksim.HandyOps.HandyOps (apw3) (HO)
